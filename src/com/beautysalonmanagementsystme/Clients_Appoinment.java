 ...
 * @author User
 */
public class Clients_Appoinment extends javax.swing.JFrame {

    /**
     * Creates new form AA
     */
    public Clients_Appoinment() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton2.setText("Clients Details:");
        ...
        jButton3.setText("Purchases Details");
        ...
        jButton4.setText("Appoinment Details:");
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Date", "Time", "Employee Name", "Service/Item Name", "Total"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Clients_Appoinment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Clients_Appoinment().setVisible(true);
            }
        });
    }
